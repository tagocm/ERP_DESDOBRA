export interface SystemOccurrenceType {
    id: string
    code: string
    label: string
    active: boolean
...
export interface SystemOccurrenceReason {
    id: string
    type_code: string
    label: string
    active: boolean
...
export interface SystemOccurrenceReasonDefault {
    id: string
    reason_id: string
...
export interface SystemOccurrenceReasonWithDefaults extends SystemOccurrenceReason {
    defaults: SystemOccurrenceReasonDefault | null
}
