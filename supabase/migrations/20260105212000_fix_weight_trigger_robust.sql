...
-- Migration: Fix Weight Trigger - Remove invalid column reference
-- Description: Removes reference to non-existent column 'base_weight_kg' causing trigger failures.
