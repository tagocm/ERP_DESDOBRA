...
-- Migration: Helper RPCs for Testing
-- Date: 2026-01-03
...
GRANT EXECUTE ON FUNCTION public.get_test_user_id() TO anon;
GRANT EXECUTE ON FUNCTION public.get_test_user_id() TO authenticated;
...
GRANT EXECUTE ON FUNCTION public.seed_test_data() TO anon;
