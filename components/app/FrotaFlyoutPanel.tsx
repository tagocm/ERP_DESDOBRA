...
interface FrotaFlyoutPanelProps {
    isOpen: boolean;
    onClose: () => void;
...
export function FrotaFlyoutPanel({ isOpen, onClose, anchorRef }: FrotaFlyoutPanelProps) {
                    ...
                    <div key={item.href} className="flex flex-col">
                        ...
                        {item.newItem && (
                            ...
                            >
                                ...
                                <Plus className="w-3.5 h-3.5 mr-2 text-gray-300 group-hover/sub:text-gray-500 transition-colors shrink-0" />
