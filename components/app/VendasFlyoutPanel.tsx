...
import { ShoppingCart, List, Plus, CornerDownRight } from "lucide-react";
import { cn } from "@/lib/utils";

interface VendasFlyoutPanelProps {
    isOpen: boolean;
    onClose: () => void;
...
export function VendasFlyoutPanel({ isOpen, onClose, anchorRef }: VendasFlyoutPanelProps) {
