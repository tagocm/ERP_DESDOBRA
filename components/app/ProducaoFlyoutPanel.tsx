...
import { CalendarClock, Factory, FileText, ClipboardList } from "lucide-react";
import { cn } from "@/lib/utils";

interface ProducaoFlyoutPanelProps {
    isOpen: boolean;
    onClose: () => void;
...
const menuItems = [
    {
        name: "Planejamento",
        href: "/app/producao/planejamento",
        icon: CalendarClock
    },
    {
...
export function ProducaoFlyoutPanel({ isOpen, onClose, anchorRef }: ProducaoFlyoutPanelProps) {
