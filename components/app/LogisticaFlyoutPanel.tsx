...
import { Map, ClipboardList, CornerDownRight, History } from "lucide-react";
import { cn } from "@/lib/utils";

interface LogisticaFlyoutPanelProps {
    isOpen: boolean;
    onClose: () => void;
...
const menuItems = [
    {
        name: "Rotas",
        href: "/app/logistica/rotas",
        icon: Map,
        description: "Roteirização e Calendário"
    },
    {
        name: "Expedição",
        href: "/app/logistica/expedicao",
        icon: ClipboardList,
        description: "Separação e Conferência"
    },
    {
        name: "Retorno",
        href: "/app/logistica/retorno",
        icon: CornerDownRight,
        description: "Gestão de Retornos"
    },
    {
        name: "Histórico de Rotas",
        href: "/app/logistica/historico",
        icon: History,
        description: "Consulta de rotas concluídas"
    }
];

export function LogisticaFlyoutPanel({ isOpen, onClose, anchorRef }: LogisticaFlyoutPanelProps) {
                ...
                {menuItems.map((item) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col flex-1 overflow-hidden">
                            ...
                            {/* Optional description if allowed/wanted, keeps it consistent with simple menu though */}
