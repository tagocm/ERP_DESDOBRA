...
export function PlanningDayDrawer({ isOpen, onOpenChange, date, data, alerts = [], onSuccess }: PlanningDayDrawerProps) {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-[90vw] w-[1400px] h-[85vh] p-0 gap-0 overflow-hidden rounded-2xl border-none shadow-2xl bg-white/95 backdrop-blur-xl ring-1 ring-black/5 flex flex-col">
                {/* Header */}
                <div className="flex flex-col space-y-1.5 p-6 border-b bg-gradient-to-b from-white to-gray-50/50 flex-none">
                    <DialogHeader>
                        <DialogTitle className="text-2xl font-bold tracking-tight text-gray-900 flex items-center gap-3">
                            <span className="bg-amber-100/50 p-2 rounded-lg text-amber-700">
                                🗓️
                            </span>
                    ...
                    <Tabs defaultValue="production" className="flex-1 flex flex-col">
                        <div className="px-6 pt-4 flex-none border-b bg-gray-50/30">
                            <TabsList className="bg-gray-100/50 p-1 rounded-lg">
                                <TabsTrigger value="production" className="data-[state=active]:bg-white data-[state=active]:shadow-sm px-4">
                                    Produção / Faltas
                                ...
                                <TabsTrigger value="alerts" className="data-[state=active]:bg-white data-[state=active]:shadow-sm px-4">
                        ...
                        <TabsContent value="production" className="flex-1 overflow-hidden p-0 m-0 data-[state=inactive]:hidden flex flex-col">
                            <ScrollArea className="flex-1 h-full">
                                <Table>
                                    <TableHeader className="bg-gray-50/80 sticky top-0 z-10 backdrop-blur-sm shadow-sm ring-1 ring-gray-100">
                                        <TableRow className="hover:bg-transparent border-gray-100 divide-x divide-gray-100">
                                            <TableHead className="w-[18%] pl-8 py-3 font-semibold text-gray-700">Produto</TableHead>
                                            <TableHead className="w-[9%] text-right py-3 font-semibold text-gray-700 bg-blue-50/30">Necessário</TableHead>
                                            <TableHead className="w-[9%] text-right py-3 font-semibold text-gray-700 bg-gray-50/50">Estoque Atual</TableHead>
                                            <TableHead className="w-[10%] text-right py-3 font-semibold text-gray-700 bg-green-50/30">Prod. Planejada</TableHead>
                                            <TableHead className="w-[10%] text-right py-3 font-semibold text-gray-700 bg-purple-50/30">Estoque Projetado</TableHead>
                                            <TableHead className="w-[9%] text-right py-3 font-semibold text-gray-700">Falta</TableHead>
                                            <TableHead className="w-[10%] text-center py-3 font-semibold text-gray-700">FT / Lotes</TableHead>
                                            <TableHead className="w-[15%] text-right pr-8 py-3 font-semibold text-gray-700">Ação</TableHead>
                                        </TableRow>
                                    </TableHeader>
                            ...
                            <div className="flex-none p-6 border-t bg-gray-50/80 backdrop-blur-sm flex items-center justify-between mt-auto">
                                <div className="flex items-center gap-6">
                                    ...
                                    <div className="flex items-center gap-2 px-4 py-1.5 bg-red-50 rounded-lg border border-red-100">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <Button
                                        ...
                                        className="bg-amber-600 hover:bg-amber-700 text-white shadow-md shadow-amber-600/10 px-6 font-semibold"
                                    >
                                        {isSubmitting ? (
                                            <>
                                ...
                                <Table>
                                    <TableHeader className="bg-red-50/80 sticky top-0 z-10 backdrop-blur-sm ring-1 ring-red-100">
                                        <TableRow className="hover:bg-transparent border-red-100">
                                            <TableHead className="w-[40%] pl-8 py-4 font-semibold text-red-800">Produto / SKU</TableHead>
        ...
        <Popover open={open} onOpenChange={setOpen}>
            <PopoverTrigger asChild>
                <Button
                    size="sm"
                    variant="ghost"
                    className="h-8 text-xs border border-amber-200 bg-amber-50 hover:bg-amber-100 text-amber-700 font-medium shadow-sm hover:shadow-md transition-all"
                >
