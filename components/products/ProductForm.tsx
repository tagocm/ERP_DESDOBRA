                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <Input
                                                        ...
                                                        placeholder="0.00"
                                                        className="mt-0.5 h-8 text-sm text-right no-spinners"
                                                        min={0}
                                                    />
                                                </div>
                                                <div>
                                                    <label className="text-[10px] font-medium text-gray-500">Largura</label>
                                                    <Input
                                                        type="number"
                                                        step="0.01"
                                                        value={formData.width_base ?? ''}
                                                        onChange={(e) => {
                                                            const val = e.target.value === '' ? undefined : parseFloat(e.target.value);
                                                            handleChange('width_base', val);
                                                        }}
                                                        placeholder="0.00"
                                                        className="mt-0.5 h-8 text-sm text-right no-spinners"
                                                        min={0}
                                                ...
                                                <div>
                                                    <label className="text-[10px] font-medium text-gray-500">Comp.</label>
                                                    <Input
                                                        type="number"
                                                        step="0.01"
                                                        value={formData.length_base ?? ''}
                                                        onChange={(e) => {
                                                            const val = e.target.value === '' ? undefined : parseFloat(e.target.value);
                                                            handleChange('length_base', val);
                                                        }}
                                                        placeholder="0.00"
                                                        className="mt-0.5 h-8 text-sm text-right no-spinners"
                                                        min={0}
                                        ...
                                        <div className="space-y-3 pt-2 border-t border-gray-100">
                                            <div className="grid grid-cols-2 gap-3">
                                                <div className="col-span-2">
                                                    <span className="text-xs font-bold text-gray-400 tracking-wider">PESOS (g)</span>
                                                </div>
                                                <div>
                                                    <label className="text-[10px] font-medium text-gray-500">Líquido</label>
                                                    <Input
                                                        type="number"
                                                        step="0.01"
                                                        value={formData.net_weight_g_base ?? ''}
                                                        onChange={(e) => {
                                                            const val = e.target.value === '' ? undefined : parseFloat(e.target.value);
                                                            handleChange('net_weight_g_base', val);
                                                        }}
                                                        placeholder="0.00"
                                                        className="mt-0.5 h-8 text-sm text-right no-spinners"
                                                        min={0}
                                                ...
                                                <div>
                                                    <label className="text-[10px] font-medium text-gray-500">Bruto</label>
                                                    <Input
                                                        type="number"
                                                        step="0.01"
                                                        value={formData.gross_weight_g_base ?? ''}
                                                        onChange={(e) => {
                                                            const val = e.target.value === '' ? undefined : parseFloat(e.target.value);
                                                            handleChange('gross_weight_g_base', val);
                                                        }}
                                                        placeholder="0.00"
                                                        className="mt-0.5 h-8 text-sm text-right no-spinners"
                                                        min={0}
