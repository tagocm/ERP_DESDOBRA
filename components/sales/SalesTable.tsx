...
import { Eye, FileText, Trash2, X, Printer, Loader2, ChevronDown, Download, CheckCircle } from "lucide-react";
...
export function SalesTable({ data, isLoading, onSelectionChange }: SalesTableProps) {
    ...
    const getApprovalStats = () => {
        ...
        selectedOrders.forEach(order => {
            ...
            const isApproved = ['approved', 'confirmed', 'billed'].includes(order.status_commercial);
                        ...
                        <DropdownMenu>
                            ...
                            <DropdownMenuContent align="start" className="w-[200px]">
                                <DropdownMenuItem
                                    ...
                                    className="cursor-pointer gap-2 text-green-700 focus:text-green-800 focus:bg-green-50"
                                >
            ...
            {(() => {
                ...
                return (
                    <ConfirmDialogDesdobra
                        ...
                        title={nothingToApprove ? "Nenhum Orçamento Apto" : "Aprovar Orçamentos em Lote"}
                        description={
                                ...
                                {nothingToApprove ? (
                                    ...
                                    <>
                                        ...
                                        <p className="text-gray-500 text-xs">
                                            Os orçamentos aprovados serão movidos para o <b>Sandbox</b> logístico automaticamente.
                                        </p>
                                    </>
                                )}
                            </div>
                        }
                        confirmText={nothingToApprove ? "Entendi" : "Confirmar Aprovação"}
