...
export interface SalesOrderDTO {
    ...
    payments?: SalesOrderPaymentDTO[];
    nfes?: SalesOrderNfeDTO[];
    history?: SalesOrderHistoryDTO[]; // Added
    adjustments?: SalesOrderAdjustmentDTO[]; // Added
...
export interface SalesOrderNfeDTO {
    id: string;
    document_id: string;
    nfe_number?: number;
    nfe_series?: number;
...
export interface SalesOrderHistoryDTO {
    id: string;
    document_id: string;
    user_id?: string;
    event_type: string;
...
export interface SalesOrderAdjustmentDTO {
    id: string;
    company_id: string;
...
export interface DeliveryRouteDTO {
    ...
    created_at: string;
    orders?: DeliveryRouteOrderDTO[];
}

export interface DeliveryRouteOrderDTO {
    id: string;
    route_id: string;
    sales_document_id: string;
    position: number;
...
export interface OrganizationOptionDTO {
    ...
    city_state?: string; // Derived from addresses
}
