...
- [ ] Check em CI (começar como warning; virar bloqueante quando estabilizar)
...
- [ ] Pipeline separando “bloqueante” vs “informativo” (budgets e warnings começam informativos)
