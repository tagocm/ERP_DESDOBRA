...
import { getRetornoRoutes } from "@/lib/data/expedition";
import { format } from "date-fns";
import { RetornoClient } from "@/components/retorno/RetornoClient";
...
export default async function RetornoPage() {
    ...
    try {
        ...
        const routes = await getRetornoRoutes(supabase, companyId, {
            dateFrom,
            dateTo
        });
        ...
        console.error("Erro ao carregar retorno:", error);
        return (
            <div className="p-8 text-center text-red-600">
